(function() {
  ...
  var translations = {
    ar: {
      ...
      'Search by model number': 'البحث برقم الموديل', 'Summer': 'صيفي', 'Autumn': 'خريفي', 'Winter': 'شتوي', 'Custom Design': 'تصميم مخصص',
      ...
      'Collection': 'المجموعة', 'Winter Collection': 'مجموعة الشتاء', 'Summer Collection': 'مجموعة الصيف', 'Autumn Collection': 'مجموعة الخريف', 'Custom Design Collection': 'مجموعة التصاميم المخصصة',
      'Model No:': 'رقم الموديل:', 'Size:': 'المقاس:', 'Weight:': 'الوزن:', 'Season:': 'الموسم:', 'Collection:': 'المجموعة:',
      ...
      'Home': 'الرئيسية', 'Menu': 'القائمة', 'Main navigation': 'التنقل الرئيسي', 'Mobile navigation': 'تنقل الهاتف', 'Product collections': 'مجموعات المنتجات', 'Yubei Apparel home': 'الصفحة الرئيسية ليوبي', 'Chat on WhatsApp': 'تواصل عبر واتساب', 'Close image': 'إغلاق الصورة', 'Close': 'إغلاق',
      "Children's clothing manufacturer and exporter in Zhili, Huzhou, China.": 'مصنّع ومصدّر لملابس الأطفال في تشيلي، هوتشو، الصين.',
      'Wholesale Kidswear': 'ملابس أطفال بالجملة', "Browse Yubei Apparel's Summer, Autumn, Winter and Custom Design children's clothing collections. Search by model number and send one organized inquiry for up to 30 selected styles.": 'تصفح مجموعات يوبي الصيفية والخريفية والشتوية والتصاميم المخصصة لملابس الأطفال، وابحث برقم الموديل وأرسل استفساراً منظماً لما يصل إلى 30 موديلًا مختاراً.',
