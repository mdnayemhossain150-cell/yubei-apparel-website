(function() {
  ...
  var translations = {
    ar: {
      ...
      'Copy Summary': 'نسخ الملخص', 'Copy Model No.': 'نسخ رقم الموديل', 'Copied!': 'تم النسخ!', 'Share Product': 'مشاركة المنتج', 'Link Copied!': 'تم نسخ الرابط!', 'Request Sample': 'طلب عينة', 'Send on WhatsApp': 'إرسال عبر واتساب', 'Send by Email': 'إرسال بالبريد', 'Clear List': 'مسح القائمة', 'Inquiry List': 'قائمة الاستفسار',
